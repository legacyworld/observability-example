...
# Log to a file
handler = logging.FileHandler(filename='/tmp/service7.log')
...
app.config['ELASTIC_APM'] = {
    ...
    'SERVICE_NAME': '07-app-ecs-logging-distributed',
...
def endpoint1():
    ...
    response = requests.get(url='http://flask8-svc:5008/endpoint1')
